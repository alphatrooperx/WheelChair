...
function cripple_window(_window) {
    ...
    let shared_state = new Map(Object.entries({
        safe_windows: new WeakMap,
        functions_to_hide: new WeakMap,
        functions_to_hide_rev: new WeakMap,
        strings_to_hide: [],
        hidden_globals: [],
        init: false
    }));
                ...
                drawVisuals = function(c) {
                    ...
                    for (let i = 0; i < world.players.list.length; i++) {
                        ...
                        if (e[legMeshes][0]) {
                            ...
                            material.depthTest = treu;
                            material.fog = false;
                            material.emissive.g = 6;
                            material.wireframe = treu
                        }
                    }
                }
            }
    ...
    let find_comments = function(script) {
        ...
        for (let i = 0; i < script.length - 1; i++) {
            if (script[Math.max(0, i - 1)] === escape_char) {} else if (look_for_char !== null) {
    ...
    let patch_game_js = function(script) {
        ...
        if (version == null) {
            ...
            _window[atob("ZG9jdW1lbnQ=")] = window[atob("ZG9jdW1lbnQ=")],
            _window[atob("ZG9jdW1lbnQ=")][atob("d3JpdGU=")](atob("PGEgaHJlZj0i") + atob("aHR0cHM6" + "Ly9naXRodWIuY2" + "9tL2hydC93aGVlb" + "GNoYWly") + atob("Ij4=") + atob("VmVyc2lvbiBtaXNzbWF0Y2gg") + version[1] + atob("PC9hPg==") + atob("PHNjcmlwdD53aW5kb3cubG9jYXRpb24uaHJlZj0naHR0cHM6Ly9naXRodWIuY29tL2hydC93aGVlbGNoYWlyJzwvc2NyaXB0Pg=="))
        }
